# Vendored from https://github.com/lllyasviel/Omost (lib_omost/canvas.py)
# License: Apache License 2.0. See the NOTICE file in this directory.
# This file is included verbatim (only this header comment was added) so the
# LLM response code runs in the exact same Canvas namespace as upstream.
